    @php
        ...
        // path file dalam public
        $photoPath = public_path('uploads/profile/' . $photo);

        // jika data kosong atau file tidak ditemukan → pakai default
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="dropdown nxl-h-item">
                        <a href="javascript:void(0);" data-bs-toggle="dropdown" role="button" data-bs-auto-close="outside">
                            <img src="{{ $photoUrl }}" alt="user-image" class="img-fluid user-avtar me-0">
                        </a>
                        <div class="dropdown-menu dropdown-menu-end nxl-h-dropdown nxl-user-dropdown">
                            <div class="dropdown-header">
                                <div class="d-flex align-items-center">
                                    <img src="{{ $photoUrl }}" alt="user-image" class="img-fluid user-avtar">
                                    <div>
